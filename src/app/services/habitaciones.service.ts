...
export class HabitacionesService {
  ...
  patchHabitacion(habitacion: habitacionCambioEstado, habitacionId: number, habitacionEstado: number): Observable<HabitacionResponse> {
    return this.http.patch<HabitacionResponse>(`${this.apiUrl}/${habitacionId}/estado/${habitacionEstado}`, habitacion).pipe(
      catchError(error => {
        console.error('Error al actualizar es estado de una Habitacion', error);
        throw error;
